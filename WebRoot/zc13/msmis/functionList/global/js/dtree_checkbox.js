...
function dTree(objName,path) {
	...
	this.icon = {
		...
		root				: '../global/images/base.gif',


		folder			: '../global/images/folder.gif',


		folderOpen	:  '../global/images/folderopen.gif',


		node				:  '../global/images/page.gif',


		empty				:  '../global/images/empty.gif',


		line				:  '../global/images/line.gif',


		join				:  '../global/images/join.gif',


		joinBottom	:  '../global/images/joinbottom.gif',


		plus				:  '../global/images/plus.gif',


		plusBottom	:  '../global/images/plusbottom.gif',


		minus				:  '../global/images/minus.gif',


		minusBottom	:  '../global/images/minusbottom.gif',


		nlPlus			:  '../global/images/nolines_plus.gif',


		nlMinus			: '../global/images/nolines_minus.gif'
	...
	if (this.config.useIcons) {
		...
		if (this.root.id == node.pid) {
 		...
 		if(this.config.check==true){
 			if(node.checked=='1'){
 				str+= '<input type="checkbox" id="c'+ this.obj + nodeId + '" value="'+ node.id+'"name="myId" onclick="javascript:'+this.obj+'.cc('+nodeId+')" checked/>';
			
 			}else{
    			str+= '<input type="checkbox" id="c'+ this.obj + nodeId + '" value="'+ node.id+'" name="myId" onclick="javascript:'+this.obj+'.cc('+nodeId+')"/>';
			}
		}

    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">重大事故列表</td>
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
					              			<tr>
												...
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">确认人</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">设备/设施名称</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">事故描述及损失范围</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">管理处</th>
											</tr>
											...
											<tr onmouseover="this.className = 'hover';" ondblclick="window.open('equipmentInfo.jsp')" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">admin</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">视频监视器</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">安防系统</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">汇龙森产业园</td>
											...
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">admin</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">火灾报警</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">汇龙森产业园</td>

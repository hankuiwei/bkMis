...
<head>
	...
	<script type="text/javascript">
		function check(){
			document.form1.action="RepairResult.do?method=addClient";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">添加维修结果</td>
											...
											<td>
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="fist_rows">
														<textarea rows="3" style="width: 150" name="result"></textarea>
														</td>
													</tr>

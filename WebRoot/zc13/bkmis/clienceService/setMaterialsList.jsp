...
<head>
	...
	<script type="text/javascript">
		...
		function searchByName(){
			document.form1.action="<%=path%>/getMeterial.do?method=selectExistMaterials";
		...
		function choose(){
            ...
            $.ajax({
				type:"post",
				url:"${pageContext.request.contextPath}/getMeterial.do?method=getMaterialCountById",
				data:{"itemIds":itemIds},
				dataType:"json",
				success:function(data){
					if(data.doStock==0){
						alert("所选用【"+data.name+"】无可用库存,请选其他材料！");
						return false;
						} 
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">选择材料信息列表</td>
										...
										<table>
											<tr>
					                			<td nowrap="nowrap"  align="right"><input class="button" type="button" value="确定" onclick="choose()"></td>
					               				<td nowrap="nowrap"><input type="button" class="button" value="取消" onclick="javasript:window.close()"></td>
					              			</tr>
					              		</table>
					              	</td>
				              	</tr>

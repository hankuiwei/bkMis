...
<body>
<form name = "form1" method="post" action = "workTask.do?method=getWorkTaskList">
							...
							<!-- 查询条件start -->
		  					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					          	...
					          	<tr>
					            	...
					            	<td nowrap="nowrap">客户名称：<input type="text" name="clientName" value="${workTaskForm.clientName }"></td>
					            	<td nowrap="nowrap">房间号：<input type="text" name="rooms" value="${workTaskForm.rooms }"></td>
					            	<td height="10" nowrap="nowrap">通知单日期：
					            		<input type="text" name="noteDate" value="${workTaskForm.noteDate }" readonly onclick="WdatePicker();" class="Wdate">&nbsp;至&nbsp;
					            		<input type="text" name="noteDateEnd" value="${workTaskForm.noteDateEnd }" readonly onclick="WdatePicker();" class="Wdate"></td>
									<td align="right" nowrap="nowrap">
					            		<input type="submit" class="button" value="查询" onclick="query()">
									</td>
								</tr>
							 	 <tr>

...
<head>
	...
	<script type="text/javascript">
		function add(){
			...
			document.form1.action ="<%=path%>/complaint.do?method=addComplaint";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">新增客户投诉</td>
												...
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="head_form1" colspan="3">
															<textarea rows="3" style="width: 80%" name="complaintContent" id="complaintContent"></textarea><font color="red">*</font>
														</td>
													</tr>
													<tr>
														<td class="head_left" align="right">
														...
														<td class="head_form1">
															<input type="text" name="complaintDate" id="complaintDate" style=" width: 138px" value="<%=GlobalMethod.getTime3() %>"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate">
														</td>
														<td class="head_form1" align="right">
															接听(接待)人：
														</td>
														<td class="head_form1">
															<input type="text" name="clerk" id="clerk">
														</td>
													</tr>

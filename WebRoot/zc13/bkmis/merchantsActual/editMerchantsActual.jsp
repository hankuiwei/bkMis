...
<head>
	...
	<script type="text/javascript">
		...
		function check(){
			...
			document.form1.action="merchantsActual.do?method=edit";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">编辑实际招商</td>
											...
											<td>
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="fist_rows">
															<input type="text" name="actualArea" value="${bean.actualArea}"  dataType="Double2" msg="必须是数字！" id="rate"> 

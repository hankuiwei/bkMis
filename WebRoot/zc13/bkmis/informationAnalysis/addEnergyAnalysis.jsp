	...
	<script type="text/javascript">
		function addAnalysis(){
			...
			if(beginDate == "" || beginDate == null){
				...
				document.addForm.action = "analysisEng.do?method=doAddEnergyAnalysis";
    			...
    			<td>
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
      					<tr>
							...
							<td width="165" nowrap="nowrap" class="form_line">添加能源分析</td>
    				...
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
    					...
    					<tr>
    						...
    						<td class="head_form1" nowrap="nowrap" colspan="3">&nbsp;
    							<input type="text" name="beginDate" id="beginDate" readonly onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM'})" class="Wdate"/>
										&nbsp;至&nbsp;
								<input type="text" name="endDate" id="endDate" readonly onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM'})" class="Wdate"/>
    						</td>
    					</tr>
    					<tr>

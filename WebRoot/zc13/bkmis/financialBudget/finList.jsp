...
<head>
	...
	<script type="text/javascript">
		...
		function add(){
			var url = "zc13/bkmis/financialBudget/addfin.jsp";
		...
		function edit(){
			...
			var url = "financialBudget.do?method=getById&id="+id;
		...
		function query(){
			document.form1.action="financialBudget.do?method=getList";
		...
		function del(){
			...
			if(confirm("确定要删除这"+k+"条记录？")){
				document.form1.action = "financialBudget.do?method=delById&ids="+str;
				document.form1.submit();
			}
		}
	</script>
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">能源耗用预算列表</td>
		  					...
		  					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					          	...
					          	<tr>
					           		<td class="txt" nowrap="nowrap" width="30%" align="center">
					           			年度：<input type="text" name="year" value="${year}" style=" width: 138px" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy'})" readonly onclick="WdatePicker();" class="Wdate">
					           		</td>
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
					              			<tr>
												...
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">预算用水量</th>
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">预算用电量</th>
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">预算用气量</th>
											...
											<c:choose>
											<c:when test="${empty financialBudgetList}">
											<tr align="center">
											...
											<c:otherwise>
											<c:forEach items="${financialBudgetList}" var="v" varStatus="tag">
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.water}</td>
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.electricity}</td>
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.gas}</td>
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.createTime}</td>
			                        <td class="RptTableBodyCell">&nbsp;
						    			<c:forEach items="${userList}" var="a">
							    			<c:if test="${v.createUser==a.userid }">${a.realName }(${a.username })</c:if>
							    		</c:forEach>
						    		</td>
											</tr>
											</c:forEach>

...
<head>
	...
	<script type="text/javascript">
		function check(){
			...
			document.form1.action="financialBudget.do?method=edit";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">编辑能源耗用预算</td>
											...
											<td>
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="fist_rows">
															<input type="text" name="createTime"  style=" width: 138px" value="${bean.createTime}"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly onclick="WdatePicker();" class="Wdate">

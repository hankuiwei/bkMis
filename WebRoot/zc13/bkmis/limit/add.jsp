					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">新增阶段性车辆限行号</td>
								...
								<td align="center">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<input type="text" name="beginDate"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" class="Wdate" value="<%=date %>" >
											到<input type="text"  name="endDate" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" class="Wdate" value="<%=date %>" ></td>
										</tr>
										<tr>

		...
		<tr>
 		...
 		<tr>
   			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<td width="165" nowrap="nowrap" class="form_line">需缴纳押金的客户</td>
		  	...
		  	<tr>
			  	<td><table width="100%"  cellpadding="0" cellspacing="0" class="form_tab">
			    	<tr>
			    		...
			    		<th class="RptTableHeadCellLock"  width="15%">应缴押金</th>
			    		<th class="RptTableHeadCellLock"  width="15%">已缴押金</th>
			    		<th class="RptTableHeadCellLock"  width="15%">需缴押金</th>
			    	</tr>
					<%if(list==null||list.size()<=0){ %>
					<tr><td colspan="12" align="center" class="head_form1"><font color="red">暂时没有押金未缴的客户!</font></td></tr>
					<%}else{ %>	
						...
						<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
						    ...
						    <td class="RptTableBodyCell">&nbsp;<%=map.get("pactExpenses") %></td>
						    <td class="RptTableBodyCell">&nbsp;<%=map.get("amount") %></td>
						    <td class="RptTableBodyCell">&nbsp;<%=map.get("payExpenses") %></td>
						   </tr>
						   <%} %>
					<%} %>

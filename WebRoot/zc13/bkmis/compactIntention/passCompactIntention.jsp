...
<head>
	...
	<script type="text/javascript">
		...
		function return1(str){
			...
			var status = "<%=Contants.THROUGHAPPROVAL%>";
			if(str=="0"){
				status = "<%=Contants.NOTTHROUGH%>";
				flag = "未通过审批";
			}
			if(window.confirm("确定"+flag+"吗?")){
				$.post("<%=path%>/intention.do",{method:"approvalIntention",id:id,status:status},function(data){
					if(data=="1"){
						alert("操作成功！");
					}else{
						alert("操作失败！");
...
<form name = "form1" method="post">
	...
	<input type="hidden" name="compactIntention.status" id="compactIntention.status" value="">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">意向书审批</td>
						...
						<td colspan="4">
							<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="head_form1" width="40%"><input type="text" name="compactIntention.taxNo" disabled="disabled"  id="compactIntention.taxNo" value="${intentionForm.compactIntention.taxNo }"></td>

...
<form name = "form1" method="post">
	...
	<!-- 返回到列表页面需要的参数end -->
	<input type="hidden" name="compactIntention.isConvertCompact" value="${intentionForm.compactIntention.isConvertCompact }" />
	<input type="hidden" id="compactIntention.lpId" name="compactIntention.lpId" value="${intentionForm.compactIntention.lpId }" />
	<input type="hidden" name="compactIntention.id" id="compactIntention.id" value="${intentionForm.compactIntention.id }">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">编辑意向书</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="head_form1" width="40%">
							...
							<input name="compactIntention.name" id="compactIntention.name" value="${intentionForm.compactIntention.name }" type="text" style="font-size:12px;width:200px">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" value="清空" class="button" onclick="clearClient();" />
						</td>
						<td class="head_form1" align="right">单位全称：</td>
						<td class="head_form1"><input type="text" id="compactIntention.unitName" name="compactIntention.unitName" value="${intentionForm.compactIntention.unitName }"><font color="red" size="3">&nbsp;&nbsp;&nbsp;*</font></td>
					</tr>
     				<tr>
						<td class="head_left" align="right" width="10%">客户代码：</td>
						<td class="head_form1">
							<input type="text" name="compactIntention.code" readonly id="compactIntention.code" value="${intentionForm.compactIntention.code }" /><font color="red" size="3">&nbsp;&nbsp;&nbsp;*</font>
						</td>
     				...
     				<tr>
						...
						<td class="head_form1"><input type="text" name="compactIntention.linkMan" id="compactIntention.linkMan" value="${intentionForm.compactIntention.linkMan }" ></td>
						<td class="head_form1" align="right" width="10%">联系电话：</td>
						<td class="head_form1"><input type="text" name="compactIntention.phone" id="compactIntention.phone" value="${intentionForm.compactIntention.phone }" ></td>
					</tr>
					<tr>
						<td class="head_left" align="right">住户类别：</td>
						<td class="head_form1">
							<span id="clientTypeSpan">
							<select onchange="seltype(this)" name="compactIntention.clientType" id="compactIntention.clientType">
							...
							<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
								<tr>
			     				...
			     				<tr>
									...
									<td class="head_form1" width="40%"><input type="text" name="compactIntention.fax" id="compactIntention.fax" value="${intentionForm.compactIntention.fax }"></td>
								</tr>
			     				<tr>
			     				...
			     				<tr>
									...
									<td class="head_form1" width="40%"><input type="text" name="compactIntention.operation" id="compactIntention.operation" value="${intentionForm.compactIntention.operation }"></td>
									<td class="head_form1" align="right" width="10%">法人代表：</td>
									<td class="head_form1"><input type="text" name="compactIntention.corporation" id="compactIntention.corporation" value="${intentionForm.compactIntention.corporation }"></td>
								</tr>
			     				<tr>
									<td class="head_left" align="right" width="10%">注册资金：</td>
									<td class="head_form1" width="40%"><input type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" name="compactIntention.loginFund" id="compactIntention.loginFund" value="${intentionForm.compactIntention.loginFund }"></td>
									<td class="head_form1" align="right" width="10%">成立时间：</td>
									<td class="head_form1"><input type="text" name="compactIntention.loginDate" id="compactIntention.loginDate" readonly onclick="WdatePicker();" value="${intentionForm.compactIntention.loginDate }" class="Wdate"></td>
								</tr>
								<tr>
									<td class="head_left" align="right" width="10%">国税号：</td>
									<td class="head_form1" width="40%"><input type="text" name="compactIntention.taxNo" id="compactIntention.taxNo" value="${intentionForm.compactIntention.taxNo }"></td>
									<td class="head_form1" align="right" width="10%">地税号：</td>
									<td class="head_form1"><input type="text" name="compactIntention.rentNo" id="compactIntention.rentNo" value="${intentionForm.compactIntention.rentNo }"></td>
								</tr>
			     				<tr>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1" width="40%" colspan="3">
							<input type="text" name="compactIntention.intentionCode" readonly="readonly" id="compactIntention.intentionCode" value="${intentionForm.compactIntention.intentionCode }">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%">
							<input type="text" name="compactIntention.roomCodes" id="compactIntention.roomCodes" value="${intentionForm.compactIntention.roomCodes }" readonly="readonly" />
						</td>
						<td class="head_form1" align="right" width="10%">总面积：</td>
						<td class="head_form1">
							<input type="text" name="compactIntention.totalArea" id="compactIntention.totalArea" value="${intentionForm.compactIntention.totalArea }" readonly="readonly" />
						</td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">签订日期：</td>
						<td class="head_form1" width="40%" colspan="3"><input type="text" name="compactIntention.signDate"  readonly onclick="WdatePicker();" value="${intentionForm.compactIntention.signDate }" class="Wdate"></td>
						
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">租赁开始日期：</td>
						<td class="head_form1" width="40%"><input type="text" name="compactIntention.beginDate" id="compactIntention.beginDate" value="${intentionForm.compactIntention.beginDate }"  readonly onclick="WdatePicker();" class="Wdate"></td>
						<td class="head_form1" align="right" width="10%">租赁结束日期：</td>
						<td class="head_form1"><input type="text" name="compactIntention.endDate"  id="compactIntention.endDate" value="${intentionForm.compactIntention.endDate }"  readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text" name="compactIntention.earnest" id="compactIntention.earnest" value="${intentionForm.compactIntention.earnest }"></td>
						<td class="head_left" align="right" width="10%">装修押金：</td>
						<td class="head_form1" width="40%"><input type="text" name="compactIntention.decorationDeposit" id="compactIntention.decorationDeposit" value="${intentionForm.compactIntention.decorationDeposit }"></td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">房租押金：</td>
						<td class="head_form1" width="40%"><input type="text" name="compactIntention.rentDeposit" id="compactIntention.rentDeposit" value="${intentionForm.compactIntention.rentDeposit }"></td>
						<td class="head_form1" align="right" width="10%">预收款周期：</td>
						<td class="head_form1" width="40%">
						<input type="text" name="compactIntention.circle" id="compactIntention.circle" value="${intentionForm.compactIntention.circle }" size="5" onchange="mustNaN(value)">&nbsp;&nbsp;月</td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">经办人：</td>
						<td class="head_form1" width="40%"><input type="text" name="compactIntention.man" id="compactIntention.man" value="${intentionForm.compactIntention.man }"></td>
						<td class="head_form1" align="right" width="10%">经办日期：</td>
						<td class="head_form1"><input type="text" name="compactIntention.date" readonly onclick="WdatePicker();" value="${intentionForm.compactIntention.date }" class="Wdate"></td>
					</tr>
					<tr>
					...
					<tr>
     				...
     				<tr>
						<td class="head_left" align="right" colspan="4">
							...
							<tr>
								    <td align="center" colspan="9"><font color="red">请选择收费标准!</font></td>
							</tr>
							</c:when>
							<c:otherwise>

...
<head>
	...
	<script type="text/javascript">
		...
		function add(){
			//var url = "zc13/bkmis/merchantsPlan/addMerchantsPlan.jsp";
			var url = "<%=path%>/merchantsPlan.do?method=addPage";
		...
		function edit(){
			...
			var url = "<%=path%>/merchantsPlan.do?method=getById&id="+id;
		...
		function query(){
			document.form1.action="merchantsPlan.do?method=getList";
		...
		function del(){
			...
			if(confirm("确定要删除这"+k+"条记录？")){
				document.form1.action = "merchantsPlan.do?method=delById&ids="+str;
				document.form1.submit();
			}
		}
	</script>
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">招商计划列表</td>
		  					...
		  					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					          	...
					          	<tr>
					           		<td class="txt" nowrap="nowrap" width="30%" align="center">
					           			年度：<input type="text" name="year"  style=" width: 138px" value="${form.year}" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy'})" readonly onclick="WdatePicker();" class="Wdate">
					           		</td>
					           		<td class="txt" nowrap="nowrap" width="20%" align="left">
					           		月份：<input type="text" name="month"  style=" width: 138px" value="${form.month}"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'MM'})" readonly onclick="WdatePicker();" class="Wdate">
					           		</td>
					           		<td class="txt" nowrap="nowrap" width="20%" align="left">
					           		责任人：<input type="text" name="responsePerson"  style=" width: 138px" value="${form.responsePerson}">
					           		</td>
								...
								<tr height = "95%">
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
											...
											<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">责任人</th>
											...
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.area}</td>
												<td width="" nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;${v.responsePerson}</td>

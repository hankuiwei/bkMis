      ...
      <td><table width="100%" align="center" cellpadding="0" cellspacing="0" style="border: 0px solid #000000;">
          ...
          <tr>
            ...
            <td><TABLE  width="100%" align="center" border=0>
                <tr>
                    <td colspan="3" align="center"><B>北控宏创预入驻客户列表</B>&nbsp;</td>
                 </tr>
          	</table></td>
          	<td width="30">&nbsp;</td>
          </tr>
			...
			<td>
				<table width="100%" cellpadding="0" cellspacing="0" class="tab">
					<tr>
						...
						<th width="8%" nowrap="nowrap" class="form1" align="center">状态</th>
					</tr>
					<c:forEach items="${destineForm.destineList}" varStatus="tag" var="v">
						<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
							...
							<td  nowrap="nowrap" class="form" align="center">${v.type }&nbsp;</td>
			                <td  nowrap="nowrap" class="form" align="center">${v.beginDate }&nbsp;</td>
			                <td  nowrap="nowrap" class="form" align="center">${v.endDate }&nbsp;</td>

	...
	<script type="text/javascript">
		...
		function addcost(){
		    ...
		    for(var i=0;i<5;i++){
		    	if(i==0){
		    		...
		    		var costCount = document.getElementsByName("beginDate");
		    		
		    		if(key==1 && costCount.length>0){
		    			key = costCount.length+1;
		    		}
		...
		function save(){
			...
			*/
			...
			selectType1();
			document.form1.action = "<%=path%>/destine.do?method=saveEditCompact&compactId="+compactId;
...
<form name = "form1" method="post">
	<table width="99%" height = "96%" align="center" border="0" cellpadding="0" cellspacing="0" style="layout:fixed">
		<tr>
    		<td height="5">
    			<input type="hidden" id="compactId" value="${destineForm.compact.id }">
    			<input type="hidden" id="lpId" name="lpId" value="${destineForm.compact.lpId }">
    		</td>
  		</tr>
  		<tr>
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">编辑预租信息</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="head_form1" width="40%"><select name="name1" id="name1" onchange="selectClient(this)" style="width:220;position:absolute;clip:rect(2 100% 90% 201)">
							...
							</select><input name="name" id="name" type="text" value="${destineForm.client.name }" size="32" style="font-size:12px;"></td>
						<td class="head_form1" align="right">单位全称：</td>
						<td class="head_form1"><input type="text" id="unitName" name="unitName" value="${destineForm.client.unitName }"></td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">客户代码：</td>
						<td class="head_form1">
							<input type="text" name="code2" disabled id="code2" value="${destineForm.client.code }">
							<input type="hidden" name="code" id="code"  value="${destineForm.client.code }">
     				...
     				<tr>
						...
						<td class="head_form1"><input type="text" name="linkMan" id="linkMan" value="${destineForm.client.linkMan }"></td>
						<td class="head_form1" align="right" width="10%">联系电话：</td>
						<td class="head_form1"><input type="text" name="phone" id="phone" value="${destineForm.client.phone }"></td>
					</tr>
					<tr>
						...
						<td class="head_form1" align="right" width="10%">&nbsp;<input type="hidden" id="clientTypeIn" value="${destineForm.client.clientType }"></td>
						<td class="head_form1">&nbsp;</td>
					</tr>
							...
							<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
								<tr>
			     				...
			     				<tr>
									...
									<td class="head_form1" width="40%"><input type="text" name="country" id="country" value="${destineForm.compact.country }"></td>
									<td class="head_form1" align="right" width="10%">&nbsp;</td>
									<td class="head_form1">&nbsp;</td>
								</tr>
			     				<tr>
									<td class="head_left" align="right" width="10%">民族：</td>
									<td class="head_form1" width="40%"><input type="text" name="nation" id="nation" value="${destineForm.compact.nation }"></td>
									<td class="head_form1" align="right" width="10%">&nbsp;</td>
									<td class="head_form1">&nbsp;</td>
								</tr>
			     				<tr>
									<td class="head_left" align="right" width="10%">籍贯：</td>
									<td class="head_form1" width="40%"><input type="text" name="residence" id="residence" value="${destineForm.compact.residence }"></td>
									<td class="head_form1" align="right" width="10%">&nbsp;</td>
									<td class="head_form1">&nbsp;</td>
								</tr>
			     				<tr>
									<td class="head_left" align="right" width="10%">身份证号：</td>
									<td class="head_form1" width="40%"><input type="text" name="identityCard" id="identityCard" value="${destineForm.compact.identityCard }"></td>
									<td class="head_form1" align="right" width="10%">&nbsp;</td>
									<td class="head_form1">&nbsp;</td>
								</tr>
							</table>
						...
						<td colspan="4">
							...
							<tr>
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="hidden" name="companyTypeIn" id="companyTypeIn" value="${destineForm.compact.companyType }">
								...
								<td class="head_form1" width="40%"><input type="text" name="fax" id="fax" value="${destineForm.compact.fax }"></td>
							</tr>
		     				<tr>
								<td class="head_left" align="right" width="10%">所属行业：</td>
								<td class="head_form1" width="40%"><input type="hidden" name="tradeIn" id="tradeIn" value="${destineForm.compact.trade }">
								...
								<td class="head_form1"><input type="hidden" name="fundTypeIn" id="fundTypeIn" value="${destineForm.compact.fundType }">
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="text" name="operation" id="operation" value="${destineForm.compact.operation }"></td>
								<td class="head_form1" align="right" width="10%">法人代表：</td>
								<td class="head_form1"><input type="text" name="corporation" id="corporation" value="${destineForm.compact.corporation }"></td>
							</tr>
							<tr>
								<td class="head_left" align="right" width="10%">注册资金：</td>
								<td class="head_form1" width="40%"><input type="text" name="loginFund" id="loginFund" value="${destineForm.compact.loginFund }"></td>
								<td class="head_form1" align="right" width="10%">成立时间：</td>
								<td class="head_form1"><input type="text" name="loginDate" id="loginDate" value="${destineForm.compact.loginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
							</tr>
							<tr>
								<td class="head_left" align="right" width="10%">国税号：</td>
								<td class="head_form1" width="40%"><input type="text" name="taxNo" id="taxNo" value="${destineForm.compact.taxNo }"></td>
								<td class="head_form1" align="right" width="10%">地税号：</td>
								<td class="head_form1"><input type="text" name="rentNo" id="rentNo" value="${destineForm.compact.rentNo }"></td>
							</tr>
			     			<tr>
								<td class="head_left" align="right" width="10%" nowrap="nowrap">是否高新技术企业：<input type="hidden" id="isHighTechIn" value="${destineForm.compact.isHighTech }"></td>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1" width="40%">
							<input type="text" disabled name="compactCode2" id="compactCode2" value="${destineForm.compact.code }">
							<input type="hidden" name="compactCode" id="compactCode" value="${destineForm.compact.code }">
						</td>
						<td class="head_form1" align="right" width="10%">合同类型：</td>
						<td class="head_form1"><select id="type" name="type">
					...
					<tr id="tr1">
						<td class="head_left" colspan="4">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class = "RptTable" id="tb">
								...
								<c:choose>
								<c:when test="${empty destineForm.eroomList}">
									<tr>
								    <td align="center" colspan="5"><font color="red">请选择房间!</font></td>
								</tr>
								</c:when>
								<c:otherwise>
								<c:forEach items="${destineForm.eroomList}" var="v" varStatus="tag">
								<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%">
							<input type="text" name="roomCodes2" id="roomCodes2" disabled value="${destineForm.compact.roomCodes }">
							<input type="hidden" name="roomCodes" id="roomCodes" value="${destineForm.compact.roomCodes }">
						</td>
						<td class="head_form1" align="right" width="10%">总面积：</td>
						<td class="head_form1">
							<input type="text" name="totalArea2" id="totalArea2" disabled value="${destineForm.compact.totalArea }">
							<input type="hidden" name="totalArea" id="totalArea"  value="${destineForm.compact.totalArea }">
						</td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">签订日期：</td>
						<td class="head_form1" width="40%" colspan="3"><input type="text" name="signDate" readonly onclick="WdatePicker();" value="${destineForm.compact.signDate }" class="Wdate"></td>
						
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">租赁开始日期：</td>
						<td class="head_form1" width="40%"><input type="text" name="beginDate"  value="${destineForm.compact.beginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
						<td class="head_form1" align="right" width="10%">租赁结束日期：</td>
						<td class="head_form1"><input type="text" name="endDate" value="${destineForm.compact.endDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>
						...
						<td class="head_form1" colspan="3">
							<table width="100%" id="cost" cellpadding="0" cellspacing="0">
								...
								<c:choose>
								<c:when test="${empty destineForm.rents}">
								</c:when>
								<c:otherwise>
								<c:forEach items="${destineForm.rents}" var="v" varStatus="tag">
								<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text" name="earnest" id="earnest" value="${destineForm.compact.earnest }" readonly="readonly"></td>
						<td class="head_left" align="right" width="10%">装修押金：</td>
						<td class="head_form1" width="40%"><input type="text" name="decorationDeposit" id="decorationDeposit" value="${destineForm.compact.decorationDeposit }"></td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">房租押金：</td>
						<td class="head_form1" width="40%"><input type="text" name="rentDeposit" id="rentDeposit" value="${destineForm.compact.rentDeposit }"><font color="red" size="3">&nbsp;&nbsp;&nbsp;</font></td>
						<td class="head_form1" align="right" width="10%">预收款周期：</td>
						<td class="head_form1" width="40%">
						<input type="text" name="circle" id="circle" size="5" value="${destineForm.compact.circle }" onchange="mustNaN(value)">&nbsp;&nbsp;月</td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">经办人：</td>
						<td class="head_form1" width="40%"><input type="text" name="man" id="man" value="${destineForm.compact.man }"></td>
						<td class="head_form1" align="right" width="10%">经办日期：</td>
						<td class="head_form1"><input type="text" name="date" value="${destineForm.compact.date }" readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">合同附加说明：</td>
						<td class="head_form1" width="40%" colspan="3"><textarea rows="3" style="width: 80%" name="instruction" id="instruction">${destineForm.compact.instruction }</textarea></td>
					</tr>
					<tr>
     				...
     				<tr>
						<td class="head_left" align="right" colspan="4">
							...
							<tr>
								...
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">房间号</td>
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">费用类型</td>
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">收费标准</td>
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">开始日期</td>
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">结束日期</td>
								<td width="15%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">数量</td>
							</tr>
							<c:choose>
								<c:when test="${empty destineForm.standardList}">
								<tr>
								    <td align="center" colspan="5"><font color="red">请选择收费标准!</font></td>
								</tr>
								</c:when>
								<c:otherwise>
								<c:forEach items="${destineForm.standardList}" var="v" varStatus="tag">
								<tr>

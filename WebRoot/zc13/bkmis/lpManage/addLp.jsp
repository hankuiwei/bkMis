...
<html>
	<head>
		...
		//添加楼盘,对于各添加项的验证
		   function checkForm(){
		       ...
		       if(trim(lpCode) == ""){
		          alert("请输入楼盘编号！");
		          return false;
		       }else if(!isNormalName(lpCode)){
		              alert("您输入的楼盘编号格式不正确，请重新输入！")
		              return false;
		       }else if(trim(lpName) == ""){
		         alert("请输入楼盘名称！");
		         return false;
		       }else{
		         $.post(url,{method:"checkLpName",lpName:lpName,forward:"addLp"},function(data){
		            if(data == 'true'){
		                if(confirm("确定要增加吗？")){
		                   //关闭窗口
		                   document.addLpForm.submit();
		...
		var flag = false;
		//删除表具信息
		//这里就这么直接从表中真的删除了，方法其实是不好的，幸亏也就是本页面是添加页面，所以就算这么删除也不影响什么，但如果在修改页面，就肯定不能这么干，
		//比如你删了一个表具，但是后来在整个大页面点的不是确定而是取消，却怎么样？
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">新增楼盘</td>
							...
							<tr>
								<td align="center">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td height="10" colspan="9"><input type="hidden" name="type" id="type"></td>
										</tr>
									</table>
								</td>
							</tr>
								...
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
										<tr>
											...
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="lpCode" name="lpCode"><font color="red">*</font></td>
											<td align="right" class="head_form1" width="23%">楼盘名称：</td>
											<td align="left" class="head_form1">&nbsp;<input type="text" id="lpName" name="lpName"><font color="red">*</font></td>
										</tr>
										<tr>
											...
											<td align="left" class="head_form1">&nbsp;<input type="text" id="ppType" name="ppType"></td>
										<tr>
										</tr>
										<tr>
											<td align="right" class="head_form1" width="12%">开发单位：</td>
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="developCompany" name="developCompany"></td>
											<td align="right" class="head_form1" width="23%">设计单位：</td>
											<td align="left" class="head_form1">&nbsp;<input type="text" id="designCompany" name="designCompany"></td>
										</tr>
										<tr>
											<td align="right" class="head_form1" width="12%">建设单位：</td>
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="buildCompany" name="buildCompany"></td>
											<td align="right" class="head_form1" width="23%">占地面积：</td>
											<td align="left" class="head_form1">&nbsp;<input type="text" id="constructionArea" name="constructionArea"></td>
										</tr>
										<tr>
											...
											<td align="left" class="head_form1">&nbsp;<input type="text" id="virescenceArea" name="virescenceArea"></td>
										</tr>
										<tr>
											<td align="right" class="head_form1" width="12%">开工日期：</td>
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="beginDate" name="beginDate" readonly onclick="WdatePicker();" class="Wdate"></td>
										...
										<tr>
											...
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="useDate" name="useDate" readonly onclick="WdatePicker();" class="Wdate"></td>
											<td align="right" class="head_form1" width="23%">联系电话：</td>
											<td align="left" class="head_form1">&nbsp;<input type="text" id="phone" name="phone"></td>
										</tr>
										<tr>
											<td align="right" class="head_form1" width="12%">传 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真：</td>
											<td align="left"  class="head_form1" width="33%">&nbsp;<input type="text" id="fax" name="fax"></td>
											<td align="right" class="head_form1" width="23%">地 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</td>
											<td align="left" class="head_form1">&nbsp;<input type="text" id="address" name="address"></td>
										</tr>
										...
										<tr>
											<td align="center" colspan="10">
												<table>
													<tr>
														<td nowrap="nowrap" align="right"><input class="button" onclick="checkForm();" type="button" value="确定" id = "focuson"></td>

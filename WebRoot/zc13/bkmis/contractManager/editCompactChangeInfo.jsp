...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			document.form1.action = "<%=path%>/customer.do?method=editCompact&flag=change&compactId="+compactId;
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">编辑变更合同</td>
    		...
    		<td class="menu_tab2">
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="head_form1">
							<input type="text" name="code2" disabled id="code2" value="${compactRoomForm.client.code }">
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1" width="40%">
							<input type="text" disabled name="compactCode2" id="compactCode2" value="${compactRoomForm.compact.code }">
						...
						<td class="head_form1">
						<input type="hidden" id="type" name="type" value="<%=Contants.COMPACTCHANGE %>">
							<%=Contants.COMPACTCHANGE %>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text" name="beginDate"  value="${compactRoomForm.compact.beginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
						<td class="head_form1" align="right" width="10%">租赁结束日期：</td>
						<td class="head_form1"><input type="text" name="endDate" value="${compactRoomForm.compact.endDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text" name="man" id="man" value="${compactRoomForm.compact.man }"></td>
						<td class="head_form1" align="right" width="10%">经办日期：</td>
						<td class="head_form1"><input type="text" name="date" value="${compactRoomForm.compact.date }" readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>

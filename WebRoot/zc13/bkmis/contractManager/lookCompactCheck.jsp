	...
	<script type="text/javascript">
		...
		function apply(){
			if(window.confirm("确定提交审批吗?")){
				...
				window.location.href="<%=path%>/customer.do?method=applyCompact1&forword=lookCompactCheck&flag=compact&id1="+compactId;
		...
		function cancel(){
			if(window.confirm("您确定要取消提交吗？")){
				...
				document.form1.action = "<%=path %>/compact.do?method=cancelChecked&id="+id+"&forward=toLookCompactCheck";
...
<form name = "form1" method="post">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">新合同校验</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
						...
						<td colspan="4">
							...
							<tr>
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="text" disabled="disabled" readonly="readonly" name="operation" id="operation" value="${compactRoomForm.compact.operation }"></td>
								<td class="head_form1" align="right" width="10%" nowrap="nowrap">法人代表：</td>
								<td class="head_form1"><input type="text" name="corporation" disabled="disabled" readonly="readonly" id="corporation" value="${compactRoomForm.compact.corporation }"></td>
							</tr>
		     				<tr>
								<td class="head_left" align="right" width="10%" nowrap="nowrap">注册资金：</td>
								<td class="head_form1" width="40%"><input type="text" disabled="disabled" readonly="readonly" name="loginFund" id="loginFund" value="${compactRoomForm.compact.loginFund }"></td>
							...
							<tr>
			     			...
			     			<tr>
								<td class="head_left" align="right" width="10%" nowrap="nowrap">是否高新技术企业：<input type="hidden" id="isHighTechIn" disabled="disabled" value="${compactRoomForm.compact.isHighTech }"></td>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1">
						<input type="hidden" value="<%=Contants.COMPACT %>" id="type" name="type">
						<%=Contants.COMPACT %>
						</td>
					</tr>
					<tr>
						...
						<td class="head_left" colspan="4">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class = "RptTable" id="tb">
								...
								<tr>
									...
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center">${v.roomCode }<input type="hidden" disabled="disabled" name="roomCode" value="${v.roomCode }">&nbsp;</td>
								    <td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center">${v.roomFullName }<input type="hidden" disabled="disabled" name="roomFullName" value="${v.roomFullName }">&nbsp;</td>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text" disabled="disabled"  readonly="readonly" value="${compactRoomForm.compact.roomCodes }"></td>
					...
					<tr>
						<td class="head_left" align="right" width="10%" nowrap="nowrap">租金自定义：</td>
						<td class="head_form1" colspan="3">
							<table width="100%" id="cost" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center"><input type="text" name="beginDateCost" disabled="disabled" value="${v.beginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center"><input type="text" name="endDateCost" disabled="disabled" value="${v.endDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
     				...
     				<tr>
						<td class="head_left" align="right" colspan="4">
							...
							<c:choose>
								...
								<tr>
									<td nowrap="nowrap" class="RptTableBodyCellLock" align="center"><input type="checkbox" name="check3" disabled="disabled"></td>
								    ...
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">${v.endDate }<input type="hidden" name="endDateStand" disabled="disabled" value="${v.beginDate }">&nbsp;</td>
	...
	<c:if test="${flag1}">
		<script type="text/javascript">
			var type = decodeURI(decodeURI("<%=Contants.COMPACT %>"));

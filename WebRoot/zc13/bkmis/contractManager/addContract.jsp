...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			document.form1.action = "<%=path%>/customer.do?method=saveCompact&flag=relet";
		...
		/**
		将给定的日期字符串dateStr增加days指定的天数
		dateStr的格式为：2011/05/05或2011-05-05
		*/
...
<form name = "form1" method="post">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">新增续租合同</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="head_form1">
							...
							<input type="text" name="code3" disabled id="code3" value="${compactRoomForm.client.code }"><font color="red" size="3">&nbsp;&nbsp;&nbsp;*</font>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1" width="40%">
							...
							<input type="text"  disabled="disabled"  name="compactCode3" id="compactCode3" value="${compactRoomForm.compact.code }">
							<input type="button" class="button" value="生成新合同编号" onclick="getNewCode()">
						</td>
						<td class="head_form1" align="right" width="10%">合同类型：</td>
						<td class="head_form1">
							<input type="hidden" id="type" name="type" value="<%=Contants.COMPACTRELET %>">
							<%=Contants.COMPACTRELET %>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%" colspan="3"><input type="text" name="signDate" readonly onclick="WdatePicker();" value="<%=nowDate %>" class="Wdate"></td>
						
					</tr>
					<tr>
						<td class="head_left" align="right" width="10%">租赁开始日期：</td>
						<td class="head_form1" width="40%">
							<input type="text" name="beginDate"  id="beginDate" value="" readonly class="Wdate" /><font color="red" style="font-size:12px;">注：租赁开始时间为上一个合同结束时间的下一天，不可修改！</font>
							<!-- 将租赁开始时间设为上一个合同的租赁结束日期的下一天 -->
							<script>document.getElementById("beginDate").value=changeDate('${compactRoomForm.compact.endDate }',1);</script>
						</td>
						<td class="head_form1" align="right" width="10%">租赁结束日期：</td>
						<td class="head_form1"><input type="text" id="endDate"  name="endDate" value="" readonly onclick="WdatePicker();" class="Wdate"></td>
					</tr>
					<tr>
						...
						<td class="head_form1" colspan="3">
							<table width="100%" id="cost" cellpadding="0" cellspacing="0">
								...
								<c:otherwise>
								<c:forEach items="${compactRoomForm.rents}" begin="${fn:length(compactRoomForm.rents)-1}" var="v" varStatus="tag">
								<tr>
									<td nowrap="nowrap" class="RptTableBodyCellLock" align="center">${tag.count }</td>
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center">
										<input type="text" name="beginDateCost" value="" readonly class="Wdate">
										<!-- 将租金开始时间设为上一个合同的租赁结束日期的下一天 -->
										<script>document.getElementsByName("beginDateCost")[0].value=changeDate('${compactRoomForm.compact.endDate }',1);</script>
									</td>
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center"><input type="text" name="endDateCost" value="" readonly onclick="WdatePicker();" class="Wdate"></td>
     				...
     				<tr>
						<td class="head_left" align="right" colspan="4">
							...
							<tr>
								...
								<td width="20%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">房间号</td>
							...
							<c:choose>
								...
								<tr>
								    ...
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">
								    	<input type="text" name="beginDateStand" value="" readonly onclick="WdatePicker();" class="Wdate">
								    	<!-- 将收费标准开始时间设为上一个合同的租赁结束日期的下一天 -->
										<script>document.getElementsByName("beginDateStand")[0].value=changeDate('${compactRoomForm.compact.endDate }',1);</script>
								    </td>
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">
								    	<input type="text" name="endDateStand" value="" readonly onclick="WdatePicker();" class="Wdate">
								    </td>
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">
								    	<input type="text" name="amount" value="${v.amount }" >
								    </td>
								</tr>
								</c:forEach>
								<!-- 将收费标准开始时间设为上一个合同的租赁结束日期的下一天 -->
								<script>
									var obj = document.getElementsByName("beginDateStand");
									for(var i = 0;i<obj.length;i++){
										obj[i].value=changeDate('${compactRoomForm.compact.endDate }',1);
									}
								</script>
								</c:otherwise>
								</c:choose>
					...
					<tr>
     				...
     				<tr>
						...
						<td class="head_form1"><input type="text" name="date"  readonly onclick="WdatePicker();" value="<%=date %>" class="Wdate" onchange="getDate(value)"></td>
					</tr>
     				<tr>
	...
	<script type="text/javascript">
		...
		if(document.getElementById("forword").value=="true"){
			alert("成功！");
			opener.location.href("<%=path%>/compact.do?method=getContractList");
			this.close();
		}
	</script>
</html>

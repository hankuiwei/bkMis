	...
	<script type="text/javascript">
		function return1(str){
			...
			if(window.confirm("确定"+flag+"吗?")){
				window.location.href("<%=path%>/compact.do?method=applyChangeOrRelet&type=change&flag="+str+"&compactId="+compactId+"&id="+changeId);
			}
		}
		function seltype(){
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">合同变更信息审批</td>
						...
						<td class="head_left" align="right" colspan="4">
							...
							<c:choose>
								...
								<tr>
									...
									<td nowrap="nowrap" class="RptTableBodyCell" align="center">${v.ERooms.roomCode }<input type="hidden" name="roomId" disabled="disabled" value="${v.ERooms.roomId }">&nbsp;</td>
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">${v.CCosttype.costTypeName }<input type="hidden" name="costTypeId" disabled="disabled" value="${v.CCosttype.id}">&nbsp;</td>
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">${v.CCoststandard.standardName }<input type="hidden" name="costStandartId" disabled="disabled" value="${v.CCoststandard.id }">&nbsp;</td>

...
<head>
	...
	<script type="text/javascript">
		function return1(str){
			...
			var reletId = document.getElementById("reletId").value;
			var flag = "通过审批";
			if(str=="0"){
				flag = "未通过审批";
			}
			if(window.confirm("确定"+flag+"吗?")){
				window.location.href("<%=path%>/compact.do?method=applyChangeOrRelet&type=relet&flag="+str+"&compactId="+compactId+"&id="+reletId);
			}
		}
		function seltype(){
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">续租合同审批</td>
						...
						<td colspan="4">
							...
							<tr>
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="text" readonly="readonly" name="loginFund" id="loginFund" value="${compactRoomForm.compact.loginFund }"></td>

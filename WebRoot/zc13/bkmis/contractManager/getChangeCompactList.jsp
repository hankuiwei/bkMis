...
<head>
	...
	<script type="text/javascript">
		...
		function edit(){
			...
			window.location.href="<%=path%>/customer.do?method=gotoEditCompact&flag=gotoChange&id="+id;
		}
		function check(){
			k = 0;
			var arr = document.getElementsByName("checkbox1");
		...
		function selectAny(){
			document.form1.action = "compact.do?method=getList&flag=change";
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">允许变更的合同列表</td>

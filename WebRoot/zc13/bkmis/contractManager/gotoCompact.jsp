    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">合同详情</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
						...
						<td colspan="4">
							...
							<tr>
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="text" readonly="readonly" disabled="disabled" name="loginFund" id="loginFund" value="${compactRoomForm.compact.loginFund }"></td>
							...
							<tr>
								...
								<td class="head_form1" width="40%"><input type="text" name="taxNo" id="taxNo" disabled="disabled" value="${compactRoomForm.compact.taxNo }"></td>
			     			...
			     			<tr>
								<td class="head_left" align="right" width="10%" nowrap="nowrap">是否高新技术企业：<input type="hidden" disabled="disabled" id="isHighTechIn" value="${compactRoomForm.compact.isHighTech }"></td>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1">
						<select disabled="disabled" id="type" name="type">
						...
						<td class="head_form1" colspan="3">
							<table width="100%" id="cost" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center"><input type="text" disabled="disabled" name="beginDateCost" value="${v.beginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
									<td width="22%" nowrap="nowrap" class="RptTableBodyCell" align="center"><input type="text" disabled="disabled" name="endDateCost" value="${v.endDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
						...
						<td class="head_left" align="right" colspan="4">
							...
							<c:choose>
								...
								<tr>
								    ...
								    <td nowrap="nowrap" class="RptTableBodyCell" align="center">${v.endDate }<input type="hidden" name="endDateStand" value="${v.endDate }">&nbsp;</td>
					...
					<tr>
     					<td align="center" colspan="4" class="head_left"><input type="button" id="focuson" value="确定" class="button" onclick="return1()"></td>
     				</tr>
				</table>
			</td>
		</tr>

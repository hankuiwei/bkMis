...
<head>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			document.form1.action = "<%=path%>/customer.do?method=editCompact&flag=relet&compactId="+compactId;
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">编辑续租合同</td>

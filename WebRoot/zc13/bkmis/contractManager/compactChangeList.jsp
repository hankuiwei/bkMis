...
<html>
<head>
	<title>compactChangeList.jsp</title>
	...
	<script type="text/javascript">
		...
		var k;
		function add(){
			window.open("compact.do?method=getList&flag=change");
		}
		function edit(){
			if(!check("编辑")){
				return;
			...
			window.open("<%=path%>/customer.do?method=gotoEditCompact&flag=changeCompact1&id="+id);
		}
		...
		function selectAny(){
			document.form1.action = "compact.do?method=getCompactChangeList";
			document.form1.submit();
		}
		function look(id){
...
<form name = "form1" method="post">
	<input type="hidden" name="type" value="<%=Contants.COMPACTCHANGE%>" />
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">合同变更情况列表</td>

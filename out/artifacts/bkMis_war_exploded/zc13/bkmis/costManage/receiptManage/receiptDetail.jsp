		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">收据详情</td>
												...
												<table width="80%" align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="fist_rows" width="30%">
															&nbsp;${receiptDetail.clientName }
 														</td>
 														<td class="head_rols" align="right" width="20%">
															收据号：
														</td>
														<td class="fist_rows" width="40%">
															&nbsp;${receiptDetail.billNum }
 														</td>
													</tr>
													<tr>
														...
														<td class="fist_rows">
															&nbsp;${receiptDetail.reciveUserName }
 														</td>
 														<td class="head_rols" align="right">
															收款日期：
														</td>
														<td class="fist_rows">
															&nbsp;${receiptDetail.reciveCostDate }
 														</td>
													</tr>
													<tr>
														<td class="head_rols" align="right">
														...
														<td class="fist_rows">
															&nbsp;<script>document.write(formatNum(parseFloat(${receiptDetail.amount }).toFixed(2).toString()));</script>
 														</td>
 														<td class="head_rols" align="right">
															已开发票金额：
														</td>
														<td class="fist_rows">
															&nbsp;<script>document.write(formatNum(parseFloat(${receiptDetail.openBill }).toFixed(2).toString()));</script>
 														</td>
													</tr>
													<tr>
														<td class="head_rols" align="right">
														...
														<td class="fist_rows" style="width:200px;WORD-WRAP:break-word;">
															&nbsp;${receiptDetail.invoiceNum }
 														</td>
 														<td class="head_rols" align="right">
															未开发票金额：
														</td>
														<td class="fist_rows">
															&nbsp;<script>document.write(formatNum(parseFloat(${receiptDetail.notOpenBill }).toFixed(2).toString()));</script>
 														</td>
													</tr>
													...
													<tr><td width="100%" colspan="4">
						  								<div id="div1" class="RptDiv"  >
		  													<table width="100%"  cellpadding="0" cellspacing="0" class="">
			    												<tr>
			    													<td class="RptTableHeadCellFullLock">发票号</td>
			    													<td class="RptTableHeadCellLock">操作员</td>
			    													<td class="RptTableHeadCellLock">操作日期</td>
			    													<td class="RptTableHeadCellLock">项目明细</td>
			    													<td class="RptTableHeadCellLock">对应发票金额</td>
			    													<td class="RptTableHeadCellLock">对应发票总金额</td>
			    													<td class="RptTableHeadCellLock">对应项目总金额</td>
			    												</tr>
			    												<c:forEach items="${invoiceForm.invoiceList}" var="v" varStatus="vs"	>
			    													<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';" >
																		<td class="RptTableBodyCellLock">&nbsp;${v.invoiceNum }</td>

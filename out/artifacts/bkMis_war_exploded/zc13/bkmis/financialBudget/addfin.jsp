...
<head>
	...
	<script type="text/javascript">
		function check(){
			document.form1.action="financialBudget.do?method=addfinan";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">添加能源耗用预算</td>
											...
											<td>
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
														...
														<td class="fist_rows">
															<input type="text" name="water"  dataType="Double2" msg="必须是数字！" id="rate"> 
														</td>
													</tr>
														<tr>
														<td class="head_rols" align="right">
														...
														<td class="fist_rows">
															<input type="text" name="electricity"  dataType="Double2" msg="必须是数字！" id="rate"> 
														</td>
													</tr>
													<tr>
														<td class="head_rols" align="right">
														...
														<td class="fist_rows">
															<input type="text" name="gas"  dataType="Double2" msg="必须是数字！" id="rate"> 
														</td>
													</tr>
													<tr>
														<td class="head_rols" align="right">
														...
														<td class="fist_rows">
															<input type="text" name="createTime"  style=" width: 138px" value="<%=GlobalMethod.getTime3() %>"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly onclick="WdatePicker();" class="Wdate">
														</td>
													</tr>												
													<tr>

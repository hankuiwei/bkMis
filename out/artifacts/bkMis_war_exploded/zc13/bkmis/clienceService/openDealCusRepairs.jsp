    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">查看客户报修处理情况</td>
    		...
    		<td class="menu_tab2">
     			<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<input type="hidden" name="amountRate" id="amountRate" value="${bean.amountRate }"></td>
						</c:if>
					...
					<tr>
						...
						<td class="head_form1" width="35%">
							<select name="department" id="department" style="width: 130" disabled="disabled">
							<c:choose>
					...
					<tr>
     				...
     				<tr>
						...
						<td class="head_form1" colspan="3"><textarea rows="3" style="width: 80%" name="checkRecord" id="checkRecord" disabled="disabled">${bean.checkRecord }</textarea></td>
					</tr>
					<tr>
						<td class="head_left" align="right">住户意见：</td>
						<td class="head_form1" colspan="3">
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="clientNotion" <c:if test="${bean.clientNotion eq '非常满意' }">checked</c:if> value="非常满意" disabled="disabled">非常满意
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="clientNotion" <c:if test="${bean.clientNotion eq '满意' }">checked</c:if> value="满意" disabled="disabled">满意
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="clientNotion" <c:if test="${bean.clientNotion eq '不满意' }">checked</c:if> value="不满意" disabled="disabled">不满意
						</td>
					</tr>

	...
	<script type="text/javascript">
		...
		function return1(str){
			...
			if(window.confirm("确定"+flag+"吗?")){
				...
				//document.form1.action = "<%=path%>/intention.do?method=approvalIntention";
		...
		//查看意向书详情
		function look(id){
			window.open("<%=path%>/intention.do?method=gotoEditIntention&forward=lookCompactIntentionPass&id="+id);
			void 0;
		}
	</script>
	<script type="text/javascript">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">待审批的意向书列表</td>

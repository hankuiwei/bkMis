	...
	<script type="text/javascript">
		...
		function apply(){
			if(window.confirm("确定提交审批吗?")){
				...
				window.location.href="<%=path%>/customer.do?method=applyCompact1&forword=lookCompactCheck&flag=intention&id1="+id;
		...
		function cancel(){
			if(window.confirm("您确定要取消提交吗？")){
				document.form1.action = "<%=path %>/compact.do?method=cancelChecked";
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">意向书校验</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
     					<td align="center" colspan="4" class="head_left">
     						...
     						<c:if test="${notsubmit eq intentionForm.compactIntention.status}">
     						<input type="button" value="提交审批" class="button" onclick="apply()">
     						</c:if>
     						<c:if test="${onapproval eq intentionForm.compactIntention.status}">

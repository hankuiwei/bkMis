...
<html>
  ...
  <body onload="loadPic()">
    	<form id="form1" action="personnel.do?method=upLoad" method="post" name="form1">
    		...
    		<input type="hidden" name="personnel.personnelId" value="${personnelForm.personnel.personnelId }" id="personnel.personnelId">
    		<input type="hidden" name="personnel.isInPost" value="${personnelForm.personnel.isInPost }" id="personnel.isInPost"/>
    		<input type="hidden" name="personnel.isOut" value="${personnelForm.personnel.isOut }" id="personnel.isOut"/>
    		<input type="hidden" name="personnel.lpId" value="${personnelForm.personnel.lpId }" id="personnel.lpId"/>
    		
    		<input type="hidden" name="pact.personnelId" value="${personnelForm.pact.personnelId }" id="pact.personnelId">
    		<input type="hidden" name="pact.pactId" value="${personnelForm.pact.pactId }" id="pact.pactId">
    		<input type="hidden" name="pact.lpId" value="${personnelForm.pact.lpId }" id="pact.lpId">
    		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    			...
    			<td>
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
      					<tr>
							...
							<td width="165" nowrap="nowrap" class="form_line">员工 ${personnelForm.personnel.personnelName }的信息编辑</td>
    			  ...
    			  <td class="menu_tab2" align="center">
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;											 
    							<input id="personnel.personnelName" type="text" name="personnel.personnelName" dataType="Require" msg="姓名不得为空！" value="${personnelForm.personnel.personnelName }"/>
    							<font color="red">*</font>
    						</td>
    						<td align="right" class="head_form1">
    							性别：
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.nation" value="${personnelForm.personnel.nation }"/>
    						</td>
    						<td align="right" class="head_form1">
    							出生日期：
    						</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.birthday" readonly onclick="WdatePicker()" id="personnel.birthday" value="${personnelForm.personnel.birthday }" class="Wdate"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">年龄：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.age" <c:if test="${personnelForm.personnel.age ne '0'}">  value="${personnelForm.personnel.age }" </c:if>/>
    						</td>
    						<td align="right" class="head_form1">员工编号：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.personnelCode" value="${personnelForm.personnel.personnelCode }" id="personnel.personnelCode"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">员工工号：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.personnelNum" onkeyup="value=value.replace(/[^\d]/g,'')" value="${personnelForm.personnel.personnelNum }"/>
    						</td>
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.identityCard" value="${personnelForm.personnel.identityCard }"/>
    						</td>
    						<td align="right" class="head_form1">
    							联系电话：
    						</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.phone" value="${personnelForm.personnel.phone }"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">政治面貌：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.groups" value="${personnelForm.personnel.groups }"/>
    						</td>
    						<td align="right" class="head_form1">健康状况：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.health" value="${personnelForm.personnel.health}"/>
    						</td>
    					</tr>
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							...
    							<c:when test="${personnelForm.personnel.marriage == '已婚'}">
    								<input type="radio" name="personnel.marriage" checked="checked" value="已婚"/>已婚
    								<input type="radio" name="personnel.marriage" value="未婚"/>未婚
    							</c:when>
    							<c:otherwise>
    								<input type="radio" name="personnel.marriage" value="已婚"/>已婚
    								<input type="radio" name="personnel.marriage" checked="checked" value="未婚"/>未婚
    							</c:otherwise> 
    							</c:choose>
    						</td>
    						<td align="right" class="head_form1">
    						...
    						<td class="head_form1">&nbsp;
    						   <input name="personnel.bloodType" type="radio" <c:if test="${personnelForm.personnel.bloodType == 'O'}">checked</c:if> value="O"/>O
    						   <input name="personnel.bloodType" type="radio" <c:if test="${personnelForm.personnel.bloodType == 'A'}">checked</c:if> value="A"/>A
    						   <input name="personnel.bloodType" type="radio" <c:if test="${personnelForm.personnel.bloodType == 'B'}">checked</c:if> value="B"/>B
    						   <input name="personnel.bloodType" type="radio" <c:if test="${personnelForm.personnel.bloodType == 'AB'}">checked</c:if> value="AB"/>AB
    						   <input name="personnel.bloodType" type="radio" <c:if test="${personnelForm.personnel.bloodType == '其它'}">checked</c:if> value="其它">其它
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">兴趣爱好：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<input type="text" name="personnel.interest" value="${personnelForm.personnel.interest}"/>
    						</td>
    					</tr>
    					<tr>
    						...
    						<td id="pic" colspan="3" class="head_form1">&nbsp;
    						  <div class="initiated_event_photo" id="event_photo_div">
    						   ...
    						   <div id="newPreview"></div> 
    							...
    							<input id="up" name="up" type="button" onclick="upPicture();" value="粘贴"/>
    							<input id="retur" type="button" name="retur" value="重设">
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">学历/学位：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.academicCertificate" value="${personnelForm.personnel.academicCertificate }"/>
    						</td>
    						<td align="right" class="head_form1">专业：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.speciality" value="${personnelForm.personnel.speciality }"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">职称/资格：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="pact.duty" value="${personnelForm.pact.duty }"/>
    						</td>
    						<td align="right" class="head_form1">外语语种：</td>
    						<td class="head_form1">&nbsp;
    							<input type="text" name="personnel.foreignLanguage" value="${personnelForm.personnel.foreignLanguage }"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">邮编：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<input type="text" name="personnel.post" value="${personnelForm.personnel.post }"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">户口所在地：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<input type="text" name="personnel.residence" value="${personnelForm.personnel.residence }"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">现居住地址：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<input type="text" name="personnel.address" value="${personnelForm.personnel.address}"/>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">档案/劳动保险情况：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<textarea rows="3" cols="20" name="personnel.labourInsurance">${personnelForm.personnel.labourInsurance}</textarea>
    						</td>
    					</tr>
    					<tr>
    						<td align="right" class="head_form1">备注：</td>
    						<td class="head_form1" colspan="3">&nbsp;
    							<textarea rows="3" cols="20" name="personnel.bz">${personnelForm.personnel.bz }</textarea>
    						</td>
    					</tr>
    				</table>
    			   </td>
    			  ...
    			  <td class="menu_tab2" align="center">
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="head_form1">&nbsp;
								<input name="pact.engageChannel" type="radio" <c:if test="${personnelForm.pact.engageChannel == '外聘'}">checked</c:if> value="外聘">外聘
								
								<input name="pact.engageChannel" type="radio" <c:if test="${personnelForm.pact.engageChannel == '内部推荐'}">checked</c:if> value="内部推荐"/>内部推荐
								
								<input name="pact.engageChannel" type="radio" <c:if test="${personnelForm.pact.engageChannel == '门户网站'}">checked</c:if> value="门户网站"/>门户网站
							</td>
							<td align="right" class="head_form1">
								推荐人：
							</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.recommendPerson" value="${personnelForm.pact.recommendPerson }"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="head_form1">&nbsp;
								<input id="pact.pactCode" type="text" name="pact.pactCode" value="${personnelForm.pact.pactCode }"/>
							</td>
							<td align="right" class="head_form1">合同签订日期：</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.pactMakeDate" readonly onclick="WdatePicker()" id="pact.pactMakeDate" value="${personnelForm.pact.pactMakeDate }" class="Wdate"/>
							</td>
						</tr> 
						<tr>
							<td align="right" class="head_form1">合同生效日期：</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.pactBeginDate" readonly onclick="WdatePicker()" id="pact.pactBeginDate" value="${personnelForm.pact.pactBeginDate }" class="Wdate"/>
							</td>
							<td align="right" class="head_form1">合同终止日期：</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.pactEndDate" readonly onclick="WdatePicker()" id="pact.pactEndDate" value="${personnelForm.pact.pactEndDate }" class="Wdate"/>
							</td>
						</tr>	
						<tr>
							<td align="right" class="head_form1">到职日期：</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.startDate" readonly onclick="WdatePicker()" id="pact.startDate" value="${personnelForm.pact.startDate }" class="Wdate"/>
							</td>
							<td align="right" class="head_form1">试用期截止日期：</td>
							<td class="head_form1">&nbsp;
								<input type="text" name="pact.tryoutEndDate" readonly onclick="WdatePicker()" id="pact.tryoutEndDate" value="${personnelForm.pact.tryoutEndDate }" class="Wdate"/>
							</td>
						</tr>			
    				</table>
    			  </td>
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="pact">
    								...
    								<c:if test = "${not empty personnelForm.pact.pactFile}">
    									<a id="loadfile" title="del" class="${personnelForm.pact.pactFile }" href="javascript:">删除</a>
    								</c:if>
    							</span>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="idFace">
    								...
    								<c:if test = "${not empty personnelForm.pact.identityCopy}">
    									<a id="loadfile" title="delidFace" href="javascript:">删除</a>
    								</c:if>
    							</span>
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="Academic">
    								...
    								<c:if test = "${not empty personnelForm.pact.academicCertificateCopy}">
    									<a id="loadfile" title="delAcademic" href="javascript:">删除</a>
    								</c:if>
    							</span>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="onduty">
    								...
    								<c:if test = "${not empty personnelForm.pact.qualificationCertificateCopy}">
    									<a id="loadfile" title="delduty" href="javascript:">删除</a>
    								</c:if>
    							</span>
    					...
    					<tr>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="report">
    								...
    								<c:if test = "${not empty personnelForm.pact.physicalExaminationReport}">
    									<a id="loadfile" title="delreport" href="javascript:">删除</a>
    								</c:if>
    							</span>
    						...
    						<td class="head_form1">&nbsp;
    							<span id="card">
    								...
    								<c:if test = "${not empty personnelForm.pact.bankCardCopy}">
    									<a id="loadfile" title="delcard" href="javascript:">删除</a>
    								</c:if>
    							</span>
    			...
    			<tr>
    				<td colspan="4" align="center">
    					<input type="button" name="button" value="提交" onclick="edit();" class="button"/>

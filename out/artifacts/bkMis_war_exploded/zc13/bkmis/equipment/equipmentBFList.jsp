    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">报废设备列表</td>
  					...
  					<tr height="95%">
					    <td valign = "top">
							...
							<table  width="100%" height = "100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed" >
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
											...
											<tr onmouseover="this.className = 'hover';" ondblclick="window.open('equipmentInfo.jsp')" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">1201</td>
											...
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">2402</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">火灾报警18</td>
											...
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">2103</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">火灾报警18</td>
								...
								<tr>
								  	<td align="right">
								      	<input type="button" class="button" value="添加" onclick="window.open('scrap/addNew.jsp');">

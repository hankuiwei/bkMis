    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">设备运行记录列表</td>
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
					              			<tr>
												...
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">记录人</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">记录时间</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">参数运行情况说明</th>
												<th width="12%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">备注</th>
											</tr>
											...
											<tr onmouseover="this.className = 'hover';" ondblclick="window.open('equipmentInfo.jsp')" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">李潇潇</td>
											...
											<tr onmouseover="this.className = 'hover';" onmouseout="this.className = '';">
												...
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">火灾报警18</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">孙俪</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">2011-05-22</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;</td>
												<td nowrap="nowrap" class="RptTableBodyCell" align="center">&nbsp;</td>

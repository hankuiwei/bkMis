		       ...
		       if(trim(lpCode) == "" ){
		         ...
		         return false;
		          ...
		          //确定修改时删除之前上传的但不用于保存的垃圾图片
		            ...
		            document.modifyLpForm.action = "<%=path%>/lp.do?method=modifyLp";
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">修改楼盘</td>
											...
											<td align="center" colspan="20">
												<table border="0">
													<tr align="center">
														...
														<td ><input type="button" class="button" value="取消" onclick="closeModify();"></td>
													</tr>
												</table>
											</td>
										</tr>

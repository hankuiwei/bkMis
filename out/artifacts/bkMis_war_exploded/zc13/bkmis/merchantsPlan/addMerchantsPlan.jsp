...
<head>
	...
	<script type="text/javascript">
		function check(){
			...
			document.form1.action="merchantsPlan.do?method=addmerchantsPlan";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">添加招商计划</td>
										...
										<tr>
						            		...
						            		<option value="4">4</option>
													...
													<tr>
														...
														<td class="fist_rows">
															<input type="text" name="area"  dataType="Double2" msg="必须是数字！" id="rate"> 
														</td>
													</tr>
													<tr>
														<td class="head_rols" align="right">

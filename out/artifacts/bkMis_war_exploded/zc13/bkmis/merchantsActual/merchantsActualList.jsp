...
<head>
	...
	<script type="text/javascript">
		...
		function add(){
			//var url = "zc13/bkmis/merchantsActual/addMerchantsActual.jsp";
			var url = "<%=path%>/merchantsActual.do?method=addPage";
		...
		function edit(){
			...
			var url = "<%=path%>/merchantsActual.do?method=getById&id="+id;
		...
		function query(){
			document.form1.action="merchantsActual.do?method=getList";
		...
		function del(){
			...
			if(confirm("确定要删除这"+k+"条记录？")){
				document.form1.action = "merchantsActual.do?method=delById&ids="+str;
				document.form1.submit();
			}
		}
	</script>
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">实际招商列表</td>

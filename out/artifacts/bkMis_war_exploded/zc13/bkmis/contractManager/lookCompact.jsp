	...
	<script type="text/javascript">
		function return1(str){
			...
			if(window.confirm("确定"+flag+"吗?")){
				...
				document.location.href("<%=path%>/compact.do?method=applyCompact&flag="+str+"&compactId="+compactId);
			}
		}
		function save(){
			var compactId = document.getElementById("compactId").value;
			var clientId = document.getElementById("clientId").value;
			document.form1.action = "<%=path%>/customer.do?method=editCompact&compactId="+compactId+"&clientId="+clientId;
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">新合同审批</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
						...
						<td colspan="4">
							...
							<tr>
		     				...
		     				<tr>
								...
								<td class="head_form1" width="40%"><input type="text" name="loginFund" disabled="disabled" id="loginFund" value="${compactRoomForm.compact.loginFund }"></td>
								<td class="head_form1" align="right" width="10%" nowrap="nowrap">成立时间：</td>
								<td class="head_form1"><input type="text" name="loginDate" id="loginDate" disabled="disabled" value="${compactRoomForm.compact.loginDate }" readonly onclick="WdatePicker();" class="Wdate"></td>
							</tr>
							<tr>
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1"><select onchange="seltype(this)" disabled="disabled" id="type" name="type"><option value="新合同" selected="selected">新合同</option><option value="续租合同">续租合同</option></select></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="head_form1" width="40%"><input type="text"  readonly="readonly" disabled="disabled" value="${compactRoomForm.compact.roomCodes }"></td>
						<td class="head_form1" align="right" width="10%">总面积：</td>
						<td class="head_form1"><input type="text" name="totalArea" id="totalArea" disabled="disabled" readonly="readonly" value="${compactRoomForm.compact.totalArea }"></td>
					</tr>
					<tr>

...
<head>
	...
	<script type="text/javascript">
		...
		function edit(){
			...
			window.location.href="<%=path%>/compact.do?method=gotoQuit&id="+id;
		}
		function check(){
			k = 0;
			var arr = document.getElementsByName("checkbox1");
		...
		function selectAny(){
			document.form1.action = "compact.do?method=getList&flag=quit";
...
<form name = "form1" method="post">
	<input type="hidden" name="flag" value="quit">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">选择要迁出的合同</td>

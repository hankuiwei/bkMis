...
<head>
	...
	<script type="text/javascript">
		function apply(){
			...
			var changeId = document.getElementById("reletId").value;
			if(window.confirm("确定提交审批吗")){
				window.location.href="customer.do?method=applyCompact1&forword=lookReletCheck&flag=relet&id="+changeId+"&id1="+compactId;
		...
		function cancel(){
			if(window.confirm("您确定要取消提交吗？")){
				...
				document.form1.action = "<%=path %>/compact.do?method=cancelChecked&id="+id+"&forward=toLookReletCheck";
...
<form name = "form1" method="post">
	...
	<table width="99%" height = "96%" align="center" border="0" cellpadding="0" cellspacing="0" style="layout:fixed">
		<tr>
    		<td height="5">
    			...
    			<input type="hidden" id="reletId" value="${id1 }">
    		</td>
  		</tr>
  		<tr>
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line" onclick="jiben()">续租合同校验</td>
     			...
     			<table width="95%" border="0" align="center" cellspacing="0" cellpadding="0">
					...
					<tr>
		     		...
		     		<tr>
						...
						<td class="head_form1">
							<input type="hidden" value="<%=Contants.COMPACTRELET %>" id="type" name="type">
							<select onchange="seltype(this)" disabled="disabled" id="type" name="type">
								<option value="新合同" selected="selected">新合同</option>
								<option value="续租合同">续租合同</option></select>
							</td>
					</tr>
					<tr>
	...
	<c:if test="${flag1}">
		<script type="text/javascript">
			var type = decodeURI(decodeURI("<%=Contants.COMPACTRELET %>"));

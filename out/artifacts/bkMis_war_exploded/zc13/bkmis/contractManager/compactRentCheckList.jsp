...
<html>
<head>
	<title>compactRentCheckList.jsp</title>
	...
	<script type="text/javascript">
		function apply(){
			...
			window.open("<%=path%>/customer.do?method=gotoLookCompact&flag=lookReletCheck&id="+id+"&id1="+id1);
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">未审批的续租合同列表</td>

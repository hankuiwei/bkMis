...
<form action="outputmanage.do?method=doAddOutput" method="post" name="form1" id="form1">
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">添加材料出库单信息</td>
						...
						<td  align="center">
							<!-- 查询条件start -->
		  					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					         	...
					         	<tr>
									<td align="left" class="head_one" colspan="4">出库单</td>
								</tr>
					          	<tr>
					            	<td align="right" class="head_left">领用人员：</td>
					            	<td class="head_form1">&nbsp;
					            		<input type="text" id="man" name="man" value="" datatype="Require" msg="领用人员不得为空！"/><font color="red">*</font>
								...
								<tr>
					            	...
					            	<td class="head_form1">&nbsp;
					            		<input type="text" name="date" id="date" style=" width: 138" readonly value="<%=GlobalMethod.getTime3() %>" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="" class="Wdate"  datatype="Require" msg="出库时间不得为空！"/><font color="red">*</font>
					            	</td>
								</tr>
							 	 <tr>
  					...
  					<tr height="95%">
					    <td valign = "top">
					    	...
					    	<table  width="100%" height = "100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed" >
								...
								<tr>
									<td>总金额：
										<input type="text" name="money" readonly="readonly" id="money"/>
										<input type="hidden" name="oldMoney" id="oldMoney">
									</td>
								</tr>
								<tr>
									<td align="center">
										<input type="button" name="up" value="提交" class="button" onclick="upForm()"/>
										<input type="button" name="retur" value="返回" onclick="javasript:window.close()" class="button"/>
									</td>
								</tr>
								<!-- 分页start -->
								<tr>

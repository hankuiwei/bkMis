...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function onload1(){
			var codeList = document.getElementById("codeList").value;
			var delType = document.getElementById("delType");
			if(codeList != "0"){
				delType.disabled=true;
			}
		}
		//编辑信息提交
		function edit(){
  ...
  <body style="overflow-y:hidden;" onload="onload1()">
    			...
    			<td>
    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
      					<tr>
							...
							<td width="165" nowrap="nowrap" class="form_line">材料类别信息</td>

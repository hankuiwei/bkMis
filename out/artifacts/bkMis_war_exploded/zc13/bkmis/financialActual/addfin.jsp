...
<head>
	...
	<script type="text/javascript">
		function check(){
			document.form1.action="financialActual.do?method=addfinan";
		    		...
		    		<td>
		    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		      				<tr>
								...
								<td width="165" nowrap="nowrap" class="form_line">添加能源耗用</td>
												...
												<table align="center" border="0" cellpadding="3"
													...
													<tr>
													 ...
													 <tr>
														...
														<td class="fist_rows">
														<input type="text" name="month"  style=" width: 138px"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'MM'})" readonly onclick="WdatePicker();" class="Wdate">
														</td>
													</tr>

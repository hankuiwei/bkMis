...
<head>
	...
	<script type="text/javascript">
		...
		function add(){
			var url = "zc13/bkmis/financialActual/addfin.jsp";
		...
		function edit(){
			...
			var url = "financialActual.do?method=getById&id="+id;
		...
		function query(){
			document.form1.action="financialActual.do?method=getList";
		...
		function del(){
			...
			if(confirm("确定要删除这"+k+"条记录？")){
				document.form1.action = "financialActual.do?method=delById&ids="+str;
				document.form1.submit();
			}
		}
	</script>
    		...
    		<td>
    			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
						...
						<td width="165" nowrap="nowrap" class="form_line">实际耗用能源列表</td>
					        		...
					        		<div id = "div1" class = "RptDiv"  >
							   			<table border="0" cellpadding="0" cellspacing="0" class = "RptTable">
					              			<tr>
												...
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">实际用水量</th>
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">实际用电量</th>
												<th width="10%" nowrap="nowrap" class="RptTableHeadCellLock" align="center">实际用气量</th>
											...
											<c:choose>
											<c:when test="${empty financialActualList}">
											<tr align="center">
											...
											<c:otherwise>
											<c:forEach items="${financialActualList}" var="v" varStatus="tag">

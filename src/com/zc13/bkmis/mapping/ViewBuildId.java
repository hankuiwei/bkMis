...
/**
 * ViewBuildId generated by MyEclipse Persistence Tools
 */

public class ViewBuildId implements java.io.Serializable {
	...
	/** minimal constructor */
	public ViewBuildId(Integer pk, String tableName) {
		this.pk = pk;
		this.tableName = tableName;
	}

	/** full constructor */
	public ViewBuildId(Integer pk, Integer id, String name, Integer parentId,
			String tableName) {
		this.pk = pk;
		this.id = id;
		this.name = name;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewBuildId))
			return false;
		ViewBuildId castOther = (ViewBuildId) other;
